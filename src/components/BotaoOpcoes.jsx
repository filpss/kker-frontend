...
export default function BotaoOpcoes({ Icon, Text, to }) {
  return (
    <Link to={to || "#"} className="w-full">
      <button className="group flex flex-col items-center justify-center p-6 bg-white border-2 border-gray-200 rounded-xl hover:border-[var(--marrom-kker-fraco)] hover:shadow-lg transition-all duration-300 min-h-[140px] w-full max-w-[200px] mx-auto">
